    ...
    <div>
      <div className="container-fluid about-container">
        <div className="row p-5">
          <div className="col-12 order-first order-md-last about-img text-center mt-0">
            <img
              src={AboutImg}
          ...
          <div className="col-12 p-2 px-md-5 mt-3">
            <div className="row about-row mb-4">
            <span className="about-title">About Us</span>
            </div>
            <p className="about-text mx-auto mt-5">Shakn is an online platform dedicated to empowering
            ...
            <p className="about-text mx-auto mt-4">Our platform is a celebration of the art of
